    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        UserTaskEntryId = c.Int(nullable: false, identity: true),
                        UserTaskId = c.Int(nullable: false),
                        UnitsCompleted = c.Decimal(nullable: false, precision: 18, scale: 2),
                        DateTimeCompleted = c.DateTime(nullable: false),
                    })
                .PrimaryKey(t => t.UserTaskEntryId)
        ...
        {
            DropForeignKey("dbo.UserTaskEntries", "UserTaskId", "dbo.UserTasks");
            ...
            DropIndex("dbo.UserTaskEntries", new[] { "UserTaskId" });
